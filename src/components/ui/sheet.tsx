...
const SheetHeader = ({
  ...
  <div
    className={cn(
      "relative flex h-20 items-center gap-4 border-b-2 px-4",
      className,
    )}
    {...props}
  >
    {showCloseButton && (
      <SheetPrimitive.Close className="flex-center smooth h-7 w-7 rounded-full bg-gray-200 text-gray-600 opacity-70 hover:text-dark hover:opacity-100 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground">
...
const SheetFooter = ({
  ...
  <div
    className={cn("flex sm:justify-end sm:space-x-2", className)}
    {...props}
  />
);
